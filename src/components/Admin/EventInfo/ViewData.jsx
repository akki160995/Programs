...
class ViewData extends Component {
    ...
    componentDidMount(){
        axios.get('http://localhost/www/Wecare/EventInfo/getbyid.php?id='+this.props.match.params.id).then( res => {
                    ...
                    <div className = "row">
                        ...
                        <div className="text-center mt-2">
                                <Link
                                    ...
                                    to={`/admin/EventInfo/edit/${this.state.Data.id}`}>
                                    View & Edit
                                </Link>
                            </div>
                    </div>
