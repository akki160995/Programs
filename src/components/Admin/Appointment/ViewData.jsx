...
class ViewData extends Component {
    ...
    componentDidMount(){
        axios.get('http://localhost/www/Wecare/Appointment/getbyid.php?id='+this.props.match.params.id).then( res => {
            ...
            <div>
                ...
                <div className = "card col-md-6 offset-md-3 shadow">
                    ...
                    <div className = "row">
                        ...
                        <div className = "col">
                            <label>Doctor: </label>
                            <div> { this.state.Data.doctor }</div>
                        </div>
                        </div>
                        <div className = "row">
                        <div className = "col">
                        ...
                        <div className="text-center mt-2">
                                <Link
                                    ...
                                    to={`/Admin/Appointment/edit/${this.state.Data.id}`}>
                                    View & Edit
                                </Link>
                            </div>
                    </div>
